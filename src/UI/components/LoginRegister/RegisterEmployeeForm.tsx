...
import { RegisterEmployee } from "../../../core/redux/userSlice";
   ...
   {({ errors, touched }) => (
    <Form>
     ...
     <Field
      ...
      as="select"
      placeholder="نقش"
      className="form-control indent-1 rounded-md shadow h-10 w-full my-2 bg-white text-green-600 "
     >
      <option value="teacher">ثبت نام به عنوان: مدرس</option>
      <option value="admin">ثبت نام به عنوان: ادمین سایت</option>
     </Field>

     {errors.role && touched.role ? (
      <div className="text-xs text-red-600 indent-2">{errors.role}</div>
     ) : null}
